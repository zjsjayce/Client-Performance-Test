...
def Launch():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/Toutiao/VideoArticleLaunch.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def EnterVideoTab():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/Toutiao/Refresh-VideoTab/Enter-VideoTab.air --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def EndApp():
...
def run_proc():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/Toutiao/VideoArticle/VideoArticle.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def mkdir(path):
    path = path.strip()
    path = path.rstrip("\\")
...
for x in xrange(0,10):
    ...
    LaunchPath = time_now
    mkpath ="/Users/jayce/PerformanceOutput/Toutiao/VideoArticle/%s" %(time_now)
    list.append(mkpath)
