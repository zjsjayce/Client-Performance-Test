...
def run_proc():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/NetEase/Refresh-VideoTab/Refresh-VideoTab.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def mkdir(path):
    path = path.strip()
    path = path.rstrip("\\")
...
for x in xrange(0,10):
    ...
    LaunchPath = time_now
    mkpath ="/Users/jayce/PerformanceOutput/NetEase/Refresh-VideoTab/%s" %(time_now)
    list.append(mkpath)
