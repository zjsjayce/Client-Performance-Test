...
def Backlist():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/NetEase/Pictures/Backlist.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def EnterPictures():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/NetEase/Pictures/EnterPictures.air    --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def EndApp():
...
def CV(path):
    ...
    os.system('python /Users/jayce/Jayce-iOSPerformance/NewsPerformance/newsreaderAuto/core/get_time.py --path %s  --methods "%s" "%s"' %(path,half1,half2))
    print whole
