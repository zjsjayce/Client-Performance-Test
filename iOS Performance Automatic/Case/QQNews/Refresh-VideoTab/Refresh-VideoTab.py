...
def Launch():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/QQNews/VideoArticleLaunch.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def EnterVideoTab():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/QQNews/Refresh-VideoTab/Enter-VideoTab.air --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def EndApp():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/QQNews/EndApp.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def run_proc():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/QQNews/Refresh-VideoTab/Refresh-VideoTab.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def mkdir(path):
    path = path.strip()
    path = path.rstrip("\\")
...
def CV(path):
    ...
    half4 = "{           'method_name': '_find_by_image',           'threshold': 0.6,           'add_to_milestone': False,           'sift':True,           'filename': 'QQNews_framework.png',           'is_image_cut': False         }"
...
for x in xrange(0,10):
    ...
    LaunchPath = time_now
    mkpath ="/Users/jayce/PerformanceOutput/QQNews/Refresh-VideoTab/%s" %(time_now)
    list.append(mkpath)
