...
def run_proc():
    os.system('python -m airtest run /Users/jayce/Jayce-iOSPerformance/Case/QQNews/Launch/Launch.air  --device iOS:///127.0.0.1:8100 --log  /Users/jayce/Desktop/Airtest')
def mkdir(path):
    path = path.strip()
    path = path.rstrip("\\")
...
for x in xrange(0,15):
    ...
    LaunchPath = time_now
    mkpath ="/Users/jayce/PerformanceOutput/QQNews/Launch/%s" %(time_now)
    list.append(mkpath)
