...
from core.helper import G, logwrap, log_in_func
...
class Template(object):
    ...
    def __init__(self, filename, threshold=None, target_pos=TargetPos.MID, record_pos=None, resolution=(), rgb=False, is_image_cut=False, sift=True):
    ...
    def _cv_match(self, screen):
        # in casePackage image file not exist in current directory:
